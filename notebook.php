                ...
                <section class="dropdown-menu on aside-md m-l-n">
                  <section class="panel bg-white">
                    ...
                    <!-- <div class="panel-body animated fadeInRight">
                      <p><a href="https://www.youtube.com/channel/UCGnh6Xo-GhfNw4q7w9z1YxA/playlists" target="_blank" class="btn btn-sm btn-facebook"><i class="fa fa-fw fa-youtube"></i> </a></p>
                    </div> -->
                  </section>
                </section>
              </div>
