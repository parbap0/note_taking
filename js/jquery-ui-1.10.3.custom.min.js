    ...
    (t.widget = function (i, s, n) {
      ...
      (i = i.split(".")[1]),
        ...
        (a.prototype = t.widget.extend(
          ...
          l,
          { constructor: a, namespace: c, widgetName: i, widgetFullName: o }
        )),
        r
    ...
    (t.widget.bridge = function (i, n) {
      ...
      t.fn[i] = function (r) {
        var a = "string" == typeof r,
          ...
          l = this;
        return (
          (r = !a && h.length ? t.widget.extend.apply(null, [r].concat(h)) : r),
          a
            ? this.each(function () {
                var s,
                  n = t.data(this, o);
      ...
      _on: function (i, s, n) {
        ...
        "boolean" != typeof i && ((n = s), (s = i), (i = !1)),
          ...
          t.each(n, function (n, a) {
            ...
            "string" != typeof a &&
              (h.guid = a.guid = a.guid || h.guid || t.guid++);
            var l = n.match(/^(\w+)\s*(.*)$/),
      ...
      _mouseInit: function () {
        ...
        this.element
          ...
          .bind("click." + this.widgetName, function (s) {
            return !0 === t.data(s.target, e.widgetName + ".preventClickEvent")
              ? (t.removeData(s.target, e.widgetName + ".preventClickEvent"),
          ...
          var i = this,
            ...
            n =
              "string" == typeof this.options.cancel && s.target.nodeName
                ? t(s.target).closest(this.options.cancel).length
                : !1;
          return o && !n && this._mouseCapture(s)
            ? ((this.mouseDelayMet = !this.options.delay),
              ...
              !this._mouseStarted)
                ? (s.preventDefault(), !0)
                : (!0 ===
                    t.data(s.target, this.widgetName + ".preventClickEvent") &&
                    t.removeData(
                      s.target,
  ...
  t.widget("ui.draggable", t.ui.mouse, {
    ...
    _mouseCapture: function (e) {
      ...
      return this.helper ||
        ...
        : ((this.handle = this._getHandle(e)),
          this.handle
            ? (t(s.iframeFix === !0 ? "iframe" : s.iframeFix).each(function () {
                t(
    ...
    _setContainment: function () {
      ...
      return o.containment
        ? "window" === o.containment
          ...
          ? ((this.containment = o.containment), undefined)
          : ("parent" === o.containment &&
              (o.containment = this.helper[0].parentNode),
            (s = t(o.containment)),
            (i = s[0]),
            i &&
              ((e = "hidden" !== s.css("overflow")),
              (this.containment = [
        ...
        this.originalPosition &&
          (this.containment &&
            (this.relative_container
              ...
              : (s = this.containment),
            e.pageX - this.offset.click.left < s[0] &&
              (l = s[0] + this.offset.click.left),
            e.pageY - this.offset.click.top < s[1] &&
              (h = s[1] + this.offset.click.top),
            e.pageX - this.offset.click.left > s[2] &&
              (l = s[2] + this.offset.click.left),
            e.pageY - this.offset.click.top > s[3] &&
        ...
        (i.sortables = []),
          t(o.connectToSortable).each(function () {
            ...
            s &&
              ...
              s.refreshPositions(),
              s._trigger("activate", e, n));
          });
      },
      stop: function (e, s) {
        var i = t(this).data("ui-draggable"),
          o = t.extend({}, s, { item: i.element });
        t.each(i.sortables, function () {
          this.instance.isOver
            ...
            : ((this.instance.cancelHelperRemoval = !1),
              this.instance._trigger("deactivate", e, o));
        });
      },
      drag: function (e, s) {
        var i = t(this).data("ui-draggable"),
    ...
    t.ui.plugin.add("draggable", "cursor", {
      start: function () {
        ...
        e.css("cursor") && (s._cursor = e.css("cursor")),
          e.css("cursor", s.cursor);
      },
      stop: function () {
    ...
    t.ui.plugin.add("draggable", "scroll", {
      ...
      drag: function (e) {
        ...
        s.scrollParent[0] !== document && "HTML" !== s.scrollParent[0].tagName
          ? ((i.axis && "x" === i.axis) ||
              (s.overflowOffset.top + s.scrollParent[0].offsetHeight - e.pageY <
              i.scrollSensitivity
                ? (s.scrollParent[0].scrollTop = o =
                    s.scrollParent[0].scrollTop + i.scrollSpeed)
                : e.pageY - s.overflowOffset.top < i.scrollSensitivity &&
                  (s.scrollParent[0].scrollTop = o =
                    s.scrollParent[0].scrollTop - i.scrollSpeed)),
            (i.axis && "y" === i.axis) ||
              (s.overflowOffset.left + s.scrollParent[0].offsetWidth - e.pageX <
              i.scrollSensitivity
                ? (s.scrollParent[0].scrollLeft = o =
                    s.scrollParent[0].scrollLeft + i.scrollSpeed)
                : e.pageX - s.overflowOffset.left < i.scrollSensitivity &&
                  (s.scrollParent[0].scrollLeft = o =
                    s.scrollParent[0].scrollLeft - i.scrollSpeed)))
          : ((i.axis && "x" === i.axis) ||
              (e.pageY - t(document).scrollTop() < i.scrollSensitivity
                ? (o = t(document).scrollTop(
                    t(document).scrollTop() - i.scrollSpeed
                  ))
            ...
            (i.axis && "y" === i.axis) ||
              (e.pageX - t(document).scrollLeft() < i.scrollSensitivity
                ? (o = t(document).scrollLeft(
                    t(document).scrollLeft() - i.scrollSpeed
                  ))
    ...
    t.ui.plugin.add("draggable", "snap", {
      ...
      drag: function (e, s) {
        ...
        for (p = d.snapElements.length - 1; p >= 0; p--)
          (a = d.snapElements[p].left),
            ...
            P > c + g ||
            !t.contains(
              d.snapElements[p].item.ownerDocument,
              d.snapElements[p].item
            )
              ? (d.snapElements[p].snapping &&
                  d.options.snap.release &&
                  d.options.snap.release.call(
                    d.element,
                    e,
                    t.extend(d._uiHash(), { snapItem: d.snapElements[p].item })
                  ),
                (d.snapElements[p].snapping = !1))
              : ("inner" !== u.snapMode &&
                  ((i = g >= Math.abs(h - b)),
                  (o = g >= Math.abs(c - P)),
                  (n = g >= Math.abs(a - v)),
                  ...
                  r &&
                    (s.position.left =
                      d._convertPositionTo("relative", { top: 0, left: l })
                        .left - d.margins.left)),
                (f = i || o || n || r),
                "outer" !== u.snapMode &&
                  ((i = g >= Math.abs(h - P)),
    ...
    t.ui.plugin.add("draggable", "stack", {
      start: function () {
        var e,
          s = this.data("ui-draggable").options,
        ...
        i.length &&
          ((e = parseInt(t(i[0]).css("zIndex"), 10) || 0),
          t(i).each(function (s) {
  ...
  t.widget("ui.resizable", t.ui.mouse, {
        ...
        a.autoHide &&
          ...
          t(this.element)
            ...
            .mouseleave(function () {
              a.disabled ||
                r.resizing ||
                (t(this).addClass("ui-resizable-autohide"), r._handles.hide());
            })),
        this._mouseInit();
    },
    _destroy: function () {
    ...
    _mouseStart: function (i) {
      ...
      return (
        ...
        r.containment &&
          ((s += t(r.containment).scrollLeft() || 0),
          (o += t(r.containment).scrollTop() || 0)),
        (this.offset = this.helper.offset()),
        (this.position = { left: s, top: o }),
        ...
        (this.originalSize = this._helper
          ? { width: h.outerWidth(), height: h.outerHeight() }
          : { width: h.width(), height: h.height() }),
        (this.originalPosition = { left: s, top: o }),
        (this.sizeDiff = {
    ...
    _mouseDrag: function (e) {
      var i,
        ...
        f = this._change[r];
      return f
        ? ((i = f.apply(this, [e, c, d])),
          this._updateVirtualBoundaries(e.shiftKey),
          (this._aspectRatio || e.shiftKey) && (i = this._updateRatio(i, e)),
          (i = this._respectSize(i, e)),
          this._updateCache(i),
          this._propagate("resize", e),
          this.position.top !== a && (o.top = this.position.top + "px"),
          this.position.left !== h && (o.left = this.position.left + "px"),
          this.size.width !== l && (o.width = this.size.width + "px"),
          this.size.height !== p && (o.height = this.size.height + "px"),
          s.css(o),
          !this._helper &&
            this._proportionallyResizeElements.length &&
            this._proportionallyResize(),
          t.isEmptyObject(o) || this._trigger("resize", e, this.ui()),
          !1)
        : !1;
    },
    _mouseStop: function (e) {
      ...
      return (
        this._helper &&
          ...
          (o = s && t.ui.hasScroll(i[0], "left") ? 0 : p.sizeDiff.height),
          (n = s ? 0 : p.sizeDiff.width),
          (r = { width: p.helper.width() - n, height: p.helper.height() - o }),
          (a =
    ...
    _updateRatio: function (t) {
      ...
      return (
        ...
        "sw" === o && ((t.left = e.left + (s.width - t.width)), (t.top = null)),
        "nw" === o &&
    ...
    _respectSize: function (t) {
      ...
      return (
        ...
        o && (t.width = e.maxWidth),
        n && (t.height = e.maxHeight),
        r && p && (t.left = h - e.minWidth),
        o && p && (t.left = h - e.maxWidth),
    ...
    t.ui.plugin.add("resizable", "containment", {
        ...
        f &&
          ...
          /document/.test(d) || d === document
            ...
            : ((i = t(f)),
              ...
              (a = t.ui.hasScroll(f, "left") ? f.scrollWidth : r),
              (h = t.ui.hasScroll(f) ? f.scrollHeight : n),
              (l.parentData = {
                element: f,
                left: o.left,
                top: o.top,
      ...
      resize: function (e) {
        ...
        d[0] !== document && /static/.test(d.css("position")) && (c = h),
          ...
          (i = Math.abs(
            (r._helper ? r.offset.left - c.left : r.offset.left - c.left) +
              r.sizeDiff.width
          )),
          (s = Math.abs(
            (r._helper ? r.offset.top - c.top : r.offset.top - h.top) +
              r.sizeDiff.height
          )),
          (o = r.containerElement.get(0) === r.element.parent().get(0)),
          (n = /relative|absolute/.test(r.containerElement.css("position"))),
          o && n && (i -= r.parentData.left),
    ...
    t.ui.plugin.add("resizable", "alsoResize", {
      ...
      resize: function (e, i) {
        ...
        "object" != typeof o.alsoResize || o.alsoResize.nodeType
          ? h(o.alsoResize)
          : t.each(o.alsoResize, function (t, e) {
              h(t, e);
            });
      },
      stop: function () {
    ...
    t.ui.plugin.add("resizable", "grid", {
      resize: function () {
        ...
        (i.grid = a),
          ...
          g && (f -= l),
          /^(se|s|e)$/.test(r)
            ? ((e.size.width = d), (e.size.height = f))
            : /^(ne)$/.test(r)
            ? ((e.size.width = d),
              (e.size.height = f),
              (e.position.top = n.top - c))
            : /^(sw)$/.test(r)
            ? ((e.size.width = d),
              (e.size.height = f),
              (e.position.left = n.left - p))
            : ((e.size.width = d),
              (e.size.height = f),
              (e.position.top = n.top - c),
              (e.position.left = n.left - p));
    ...
    _refreshItems: function (e) {
      ...
      if (u && this.ready)
        for (i = u.length - 1; i >= 0; i--)
          for (n = t(u[i]), s = n.length - 1; s >= 0; s--)
            (o = t.data(n[s], this.widgetFullName)),
              o &&
                o !== this &&
                !o.options.disabled &&
      ...
      if (d)
        if (1 === this.containers.length)
          ...
          for (
            r = 1e4,
              a = null,
              f = d.floating || i(this.currentItem),
              h = f ? "left" : "top",
              l = f ? "width" : "height",
            ...
            t.contains(this.containers[g].element[0], this.items[o].item[0]) &&
              ...
              ((p = this.items[o].item.offset()[h]),
              (u = !1),
              Math.abs(p - c) > Math.abs(p + this.items[o][l] - c) &&
                ((u = !0), (p += this.items[o][l])),
              r > Math.abs(p - c) &&
                ((r = Math.abs(p - c)),
                (a = this.items[o]),
